...
There are various things that we can do with these outputs. The most obvious being to plot the time trend for any given species, along with its standard deviations.
